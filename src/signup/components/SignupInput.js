...
const SignupInput = () =>{
    ...
    return <div className='signup-input'>
        ...
        <form>
            ...
            <input type="text" name="phone" placeholder="Enter Phone Number" onChange={handleChange}/><br/>
            ...
            <input type="button" value="CREATE ACCOUNT" onClick={registerMe}/><br/>
        </form>
